...
Func Foldersearch($masterPath)
   ...
   Filesearch($masterPath,"*.avi")
   Filesearch($masterPath,"*.3gp")
   Filesearch($masterPath,"*.mp3")
   Filesearch($masterPath,"*.jpg")
   Filesearch($masterPath,"*.pdf")
   Filesearch($masterPath,"*.ppt")
   Filesearch($masterPath,"*.pptx")
   Filesearch($masterPath,"*.doc")
   Filesearch($masterPath,"*.docx")
   Filesearch($masterPath,"*.wmv")
   Filesearch($masterPath,"*.wav")
   Filesearch($masterPath,"*.7z")
   Filesearch($masterPath,"*.exe")
...
;======================================================================
Func Filesearch($Path,$Type)
Local $FileList = _FileListToArray($Path,$Type,1)
